...
RSpec.describe User, type: :model do
  ...
  it "requires an email address" do
    sherlock = User.new(first_name: 'Sherlock', last_name: nil, email: nil, password: 'elementary')
  ...
  it "requires a password" do
    sherlock = User.new(first_name: 'Sherlock', last_name: nil, email: 'sherlock@example.com', password: nil)
